...
- Filtering by status, priority, and CI name
...
| `ci_name` | string | - | Filter by CI_Name |
...
# 9. List tickets filter by CI_Name
curl "http://localhost:3000/tickets?ci_Name=Payment%20API"
